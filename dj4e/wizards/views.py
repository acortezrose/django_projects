...
class MainView(LoginRequiredMixin, View):
	def get(self, request):
		...
		context = { 'housecount': mc, 'wizardlist': al };
		return render(request, 'wizards/wizard_list.html', context)
...
class HouseView(LoginRequiredMixin, View):
        def get(self, request):
                ...
                context = { 'houselist': ml };

                return render(request, 'wizards/house_list.html', context)
