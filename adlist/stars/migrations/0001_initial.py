# Generated by Django 2.1.5 on 2019-04-19 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distanc', models.PositiveIntegerField()),
                ('diameter', models.PositiveIntegerField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('comments', models.ManyToManyField(related_name='auto_comments', through='stars.Comment', to=settings.AUTH_USER_MODEL)),
